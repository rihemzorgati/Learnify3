...
<head>
    ...
    <title>Teacher Details - Learnify </title>
    <!-- General CSS Files -->
                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?= base_url('admin/about_developer') ?>">About
                                        Maker</a>
                                </li>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Teacher Details | <?= $detail->nama_guru ?> </h2>
                            <hr>
                    ...
                    <div id="detail" class="col-md-12 bg-white p-3" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                        <h1 class="font-weight-bold card-title text-center" style="color: black;">Teacher Details </h1>
                        <p class="text-center" style="line-height: 5px;">The following is the detailed data contained in the database, including CIN, Name, Email and Subject being taught.</p>
                        <hr>
                        <table style="width: 100%" class="container text-center">
                            <tbody>
                                <tr style="border-bottom: 0.5px solid #6c757d;">
                                    <td><span class="font-weight-bold">Employee ID number :</span></td>
                                    <td> <?= $detail->nip ?></td>
                                </tr>
                                <tr style="border-bottom: 0.5px solid #6c757d;">
                                    <td><span class="font-weight-bold">Teacher name :</span></td>
                                ...
                                <tr style="border-bottom: 0.5px solid #6c757d;">
                                    <td><span class="font-weight-bold">Subjects :</span></td>
                        ...
                        <a href="<?= base_url('admin/data_guru') ?>" class="btn btn-success btn-block">Return</a>
                    </div>
                </section>
            </div>
        </div>
