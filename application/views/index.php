	...
	<div class="banner_inner d-flex align-items-center">
		...
		<div class="container">
			<div class="banner_content text-center">
				<h3 data-aos="fade-up" data-aos-duration="1600">Study Anywhere & Anytime<br /> Easy With Learnify</h3>
				<a data-aos="fade-up" data-aos-duration="2000" class="main_btn" href="<?= base_url('user/registration') ?>#registration">Registration Now <span class="lnr lnr-arrow-right"></span></a>
			</div>
		</div>
	</div>
</section>
				...
				<div class="finance_item">
					<div data-aos="fade-right" data-aos-duration="1600" class="media">
						...
						<div class="media-body">
							<h5>Admin, User & Teacher Data Management</h5>
						</div>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-sm-6">
				<div class="finance_item">
					<div data-aos="fade-right" data-aos-duration="1800" class="media">
						...
						<div class="media-body">
							<h5>Complete & Clear Documentation</h5>
						</div>
					</div>
				</div>
			</div>
			<div data-aos="fade-right" data-aos-duration="2000" class="col-lg-3 col-sm-6">
				<div class="finance_item">
					<div class="media">
						...
						<div class="media-body">
							<h5>Video-Based E-Learning and Discussion</h5>
						</div>
					</div>
				</div>
			</div>
			<div data-aos="fade-right" data-aos-duration="2200" class="col-lg-3 col-sm-6">
				<div class="finance_item">
					<div class="media">
						...
						<div class="media-body">
							<h5>Free with Open-Source License</h5>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-7 mx-auto">
				<div class="main_title">
					<h2 data-aos="fade-up" data-aos-duration="2000">Learnify Was Made To Improve The Quality Of Learning</h2>
					</div>
			</div>
		</div>
	</div>
...
<section class="courses_area p_40">
	<div class="container">
		<div class="main_title">
			<h2 data-aos="fade-up" data-aos-duration="1600">Lessons Available on Learnify</h2>
		</div>
		<div class="row courses_inner">
				...
				<div class="grid_inner">
					<div class="grid_item wd55">
						<div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
							...
							<div class="hover_text">
								<a class="cat" href="#" data-target="#exampleModalCenter" data-toggle="modal">Enter class</a>
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-user"></i>Mathematics Teacher</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="grid_item wd44">
						<div class="courses_item" data-aos="fade-down" data-aos-duration="1800">
							<img src="<?= base_url('assets/') ?>img/courses/computer.png" alt="">
							<div class="hover_text">
								<a class="cat" href="#" data-target="#exampleModalCenter" data-toggle="modal">Enter class</a>
								<a href="javaScript:void(0);">
									<h4>Computer Science Class</h4>
								</a>
								<ul class="list">
									<li><a href="#"><i class="lnr lnr-users"></i> 34</a></li>
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> Computer Science Teacher</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> English Teacher</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="courses_item" data-aos="fade-up" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> French Teacher</a>
									</li>
								</ul>
							</div>
						</div>
			...
			<div class="col-lg-3">
				<div class="course_item" data-aos="fade-left" data-aos-duration="1800">
					<img src="<?= base_url('assets/') ?>img/courses/eco.png" alt="">
					<div class="hover_text">
						<a class="cat" href="#" data-target="#exampleModalCenter" data-toggle="modal">Enter class</a>
						<a href="javaScript:void(0);">
							<h4>Economy Class</h4>
						...
						<ul class="list">
							...
							<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
							<li><a href="#"><i class="lnr lnr-user"></i> Economics Teacher</a></li>
						</ul>
					</div>
				</div>
			</div>
...
<section class="impress_area p_120">
	<div class="container">
		<div class="impress_inner text-center">
			<h2 data-aos="fade-up" data-aos-duration="1800">LOGIN & Registration AS TEACHER AND UPLOAD MATERIALS & VIDEOS NOW</h2>
