...
<head>
    ...
    <title>Matematika | Kelas 1 - Learnify</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;">
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1 text-center">
                    ...
                    <p>Mathematics - Class 1</p>
                    <hr width="80%">
                    <p data-aos="fade-down" class="font-weight-bold" data-aos-duration="1800">Please select the material you want to access below!                    </p>
                </div>
            </div>
        </div>
    </div>
